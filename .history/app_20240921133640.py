...
template=f'''
Objective:
Generate a high-quality, SEO-optimized article targeting [{}] using the following keywords: [Keywords]. The article should have a compelling and powerful title that attracts readers and performs well in search engine rankings.
